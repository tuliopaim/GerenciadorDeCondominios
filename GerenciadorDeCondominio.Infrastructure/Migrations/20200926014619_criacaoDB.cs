    ...
    public partial class criacaoDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricosRecursos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoricosRecursos_Meses_MesId",
                        column: x => x.MesId,
                        principalTable: "Meses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicosPredio", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "056fa343-de42-4a20-8fa4-c9425d58486d", "3696fd33-ff1f-4b64-9d39-be4ed2daf0f5", "Morador do Prédio", "Morador", "MORADOR" },
                    { "15dc607d-485a-4703-84d5-27f83c5f9144", "428c8c86-f6a1-45fd-bf3d-1818802ae9b1", "Síndico do Prédio", "Síndico", "SINDICO" },
                    { "33d94ed5-aadc-474b-a578-c3e5d3018e58", "ff2eb531-0f9f-4bd1-90d2-b085452d8461", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoricosRecursos_MesId",
                table: "HistoricosRecursos",
                column: "MesId",
                unique: true);
